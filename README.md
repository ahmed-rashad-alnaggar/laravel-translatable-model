...
// retrieves the translation in the current locale, applying the model's
...
| `getTranslatables()`                                          | `array<string>`          | Get all declared or discovered translatable keys                                                                                                                        |
| `getConcreteTranslatables()`                                  | `array<string>`          | Get every concrete translatable attribute for the current model instance, expanding nested wildcard-declared attributes into their concrete positional keys.            |
